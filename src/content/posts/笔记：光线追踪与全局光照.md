...
因为交点一定在光线上，所以将光线方程  $\mathbf{p} = \mathbf{o} + t\vec{d}$ 代入上式可得：

$$
t^2 (\vec{d}\cdot\vec{d}) + 2t (\mathbf{o} - \mathbf{c})\cdot\vec{d} + (\mathbf{o} - \mathbf{c})\cdot(\mathbf{o} - \mathbf{c}) - r^2 = 0 （关于 t 的一元二次方程）
$$
...
<p align="center">
  <img src="/public/markdown_picture/md_RayTracing/AABB-Slab.png" width="400">
</p>
