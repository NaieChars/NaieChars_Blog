	...
	integrations: [
		...
		expressiveCode({
			...
			styleOverrides: {
				...
				codeFontFamily:
					"Consolas, 'JetBrains Mono Variable', SFMono-Regular, Menlo, Monaco, 'Liberation Mono', 'Courier New', 'Microsoft JhengHei', '微軟正黑體', 'Microsoft YaHei', '微软雅黑', 'Noto Sans HK', 'Noto Sans TC', 'Noto Sans JP', 'Noto Sans SC', 'Noto Sans KR', ui-monospace, monospace",
